...
HEADERS = blobs_finder.hpp blobs_tracker.hpp utility.hpp framereader.hpp
...
OBJECTS_2014 = subtracker2014.o subotto_tracking.o ball_density.o utility.o subotto_metrics.o blobs_tracker.o v4l2cap.o
...
framereader_test: framereader_test.cpp framereader.hpp v4l2cap.o
	$(CPP) $(CPPFLAGS) -o $@ $< v4l2cap.o $(LIBS)
